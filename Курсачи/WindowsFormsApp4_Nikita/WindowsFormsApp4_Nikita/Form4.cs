...
namespace WindowsFormsApp4_Nikita
{
    public partial class Form4 : Form
    {
        ...
        private void количестваToolStripMenuItem1_Click(object sender, EventArgs e)
        {
            kvadroinfoBindingSource.DataSource = Kvadro_info.Kvadro_info_list = Kvadro_info.Kvadro_info_list.OrderBy(x => x.Kol_vo).ToList<Kvadro_info>();
            kvadroinfoBindingSource.ResetBindings(false);
        }
        ...
        private void ценыToolStripMenuItem1_Click(object sender, EventArgs e)
        {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                string a = Kvadro_info.Add_info(textBox1.Text, textBox2.Text, int.Parse(textBox3.Text), int.Parse(textBox4.Text), int.Parse(textBox5.Text), int.Parse(textBox6.Text));
                Kvadro_info.Load_info();
                kvadroinfoBindingSource.ResetBindings(false);
                if (a == "успешно")
                {
                    Log("Добавил новый квадроцикл", textBox1.Text + " " + textBox2.Text + " " + textBox3.Text + " " + textBox4.Text + " " + textBox5.Text + " " + textBox6.Text);
                    textBox_clearing();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            try
            {
                string a = Kvadro_info.Delete_info(textBox1.Text, textBox2.Text, int.Parse(textBox3.Text));
                Kvadro_info.Load_info();
                kvadroinfoBindingSource.ResetBindings(false);
                if (a == "успешно")
                {
                    Log("Удалил квадрацикл", textBox1.Text + " " + textBox2.Text + " " + textBox3.Text);
                    textBox_clearing();
                    MessageBox.Show("Успешно!");
                }
                else MessageBox.Show("Вы ввели некорректные данные!");
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                string a = Kvadro_info.Change_info(textBox1.Text, textBox2.Text, int.Parse(textBox3.Text), int.Parse(textBox4.Text), int.Parse(textBox5.Text), int.Parse(textBox6.Text));
                Kvadro_info.Load_info();
                kvadroinfoBindingSource.ResetBindings(false);
                if (a == "успешно")
                {
                    MessageBox.Show("Успешно!");
                    Log("Изменил информацию о квадрацикле", textBox1.Text + " " + textBox2.Text);
                    textBox_clearing();
                }
                else MessageBox.Show("Вы ввели некорректные данные!");
            }
        ...
        {
            //Сбор статистики по квадрациклам и запись в файл.
            string comp1 = "";
            string comp2 = "";
            string comp3 = "";
            string comp4 = "";
